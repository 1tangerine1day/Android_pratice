...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_DATA_UPDATE_ANSWER = "extra_ans_to_be_updated";
...
//                        adapter.notifyDataSetChanged();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Word word = new Word(0,data.getStringExtra(NewWordActivity.EXTRA_REPLY1),data.getStringExtra(NewWordActivity.EXTRA_REPLY2));
            // Save the data
            ...
            // Update the data
            Word word = new Word(data.getIntExtra(NewWordActivity.EXTRA_REPLY3,0),data.getStringExtra(NewWordActivity.EXTRA_REPLY1),data.getStringExtra(NewWordActivity.EXTRA_REPLY2));
    ...
    public void launchUpdateWordActivity( Word word) {
        ...
        intent.putExtra(EXTRA_DATA_UPDATE_ID, word.getId());
