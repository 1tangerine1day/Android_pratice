...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marketPref = sharedPref.getString("sync_frequency", "-1");
        displayToast(marketPref);
        //huzy
        marketMethod = sharedPref.getString("choose_a_delivery_method_list", "pick up");
        displayToast(marketMethod);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_status:
                displayToast(getString(R.string.action_status_message) + " " + marketPref);
                return true;
